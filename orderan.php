...
<section class="table">
    ...
    <thead>
        <tr>
            <th colspan="6"><h1>data Orderan</h1></th>
        </tr>
        <tr>
            <th width="60px">No</th>
            <th><h1>Id Pelanggan</h1></th>
            <th><h1>Tanggal Order</h1></th>
            <th><h1>Jumlah Pesanan</h1></th>
            <th><h1>Total Pesanan</h1></th>
...
$no = 1;
// Fetch customers starting with 'a'
$sql = "SELECT * FROM orders ";
$query = mysqli_query($conn, $sql);
        
while($orderan = mysqli_fetch_array($query)){
    echo "<tr>";
    
    echo "<td><h1>".$no++. "</h1></td>";
    echo "<td><h1>".$orderan['id_customers']."</h1></td>";
    echo "<td><h1>".$orderan['tgl_order']."</h1></td>";
    echo "<td><h1>".$orderan['jumlah_pesanan']."</h1></td>";
    echo "<td><h1>".$orderan['total_pesanan']."</h1></td>";
